...
{
    public class CountryDataModelSQServer : SQLServerDataModelBase, ICountryDataModel
    {
        #region Constructors

        public CountryDataModelSQServer(IConfiguration configuration, ILogger<CountryDataModelSQServer> logger)
            : base(configuration, logger)
        { }

        public CountryDataModelSQServer(string dbconnection, ILogger<CountryDataModelSQServer> logger)
